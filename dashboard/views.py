...
class DashboardTemplateView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['member_type_investor_business'] = MemberType.objects.get(name='Investor Business').member_set.count()
        context['member_type_investor_individual'] = MemberType.objects.get(name='Investor Individual').member_set.count()
